...
import id.co.tetanggakita.databinding.ActivityWargaBinding
import id.co.tetanggakita.model.ResponseUser
import id.co.tetanggakita.network.ApiConfig
...
class WargaActivity : AppCompatActivity() {
    ...
    private val binding by lazy { ActivityWargaBinding.inflate(layoutInflater) }
            ...
            override fun onResponse(call: Call<ResponseUser>, response: Response<ResponseUser>) {
                if (response.isSuccessful) {
                    ...
                    if (dataArray != null) {
                        ...
                        Toast.makeText(this@WargaActivity, "No data available", Toast.LENGTH_SHORT).show()
                    }
                } else {
                    Toast.makeText(this@WargaActivity, "Failed to retrieve data", Toast.LENGTH_SHORT).show()
                }
            }

            override fun onFailure(call: Call<ResponseUser>, t: Throwable) {
                Toast.makeText(this@WargaActivity, "Error: ${t.message}", Toast.LENGTH_SHORT).show()
                t.printStackTrace()
            }
        })
    }
